...
import SideBar2 from "../../components/templates/side-bar2.tsx";
import Realtime from "../../components/organisms/realtime11.tsx";


const COLLAPSEMANAGEUSERADMIN: NextPage = () => {
  ...
  return (
    <div className="w-full relative bg-white overflow-hidden flex flex-row items-start justify-start py-0 pr-9 pl-0 box-border gap-[39px] leading-[normal] tracking-[normal] mq725:gap-[19px] mq975:pl-5 mq975:box-border">
      <SideBar2 />
      <section className="flex-1 flex flex-col items-start justify-start pt-[34px] px-0 pb-0 box-border max-w-[calc(100%_-_324px)] text-left text-xl text-font-grey font-poppins mq975:max-w-full">
        <div className="self-stretch flex flex-col items-start justify-start gap-[39px] max-w-full mq725:gap-[19px]">
...
export default COLLAPSEMANAGEUSERADMIN;
