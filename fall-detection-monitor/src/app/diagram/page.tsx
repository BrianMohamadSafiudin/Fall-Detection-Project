...
const DIAGRAMFALLDETECTION: NextPage = () => {
  ...
  return (
    <div className="w-full relative bg-white overflow-hidden flex flex-row items-start justify-start py-0 pr-9 pl-0 box-border gap-[41px] leading-[normal] tracking-[normal] mq900:gap-[20px] mq900:pl-5 mq900:box-border">
      <Sidebar />
      <main className="flex-1 flex flex-col items-start justify-start pt-[34px] px-0 pb-0 box-border max-w-[calc(100%_-_111px)] mq900:max-w-full">
        <section className="self-stretch flex flex-col items-start justify-start gap-[40px] max-w-full mq675:gap-[20px]">
          <div className="self-stretch flex flex-col items-start justify-start gap-[30px] max-w-full">
            <header className="self-stretch flex flex-row items-start justify-between max-w-full gap-[20px] text-left text-xl text-font-grey font-poppins">
              <div className="flex flex-col items-start justify-start pt-0.5 px-0 pb-0">
                <div className="flex flex-col items-start justify-start gap-[7px] mq675:hidden">
              ...
              <div className="w-[366px] flex flex-row items-start justify-start gap-[36px] max-w-full text-sm text-font-dis mq450:gap-[18px]">
                <div className="flex-[0.9259] flex flex-col items-start justify-start pt-[5px] pb-0 pr-2 pl-0">
                  <div
...
export default DIAGRAMFALLDETECTION;